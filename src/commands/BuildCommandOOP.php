...
class BuildCommandOOP extends Command {
    /**
    ...
    public function handle() {
        ...
        $this->info( "Creating $this->projectFolder - $this->environment Build verion $version" );
...
//        ] );
    ...
    protected function setEnvironmentFile(){

        $newEnv = $this->projectPath . "/environments/.env." . $this->environment;
